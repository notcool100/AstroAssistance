  ...
  <div class="max-w-md w-full space-y-8">
    <div>
      ...
      <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
        Or
        <Link to="/" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        ...
        <div>
          ...
          <input
            ...
            autocomplete="email"
            required
            class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 dark:bg-gray-800 dark:border-gray-700 dark:text-white sm:text-sm"
